...
Shader "Custom/Physically Based Lighting" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
			...
			VertexOutput vert (VertexInput v) {
				 ...
				 o.tangentDir = normalize( mul( unity_ObjectToWorld, /*float4( Corporate governance and insider trading resources, 0.0 )*/ v.tangent).xyz );
